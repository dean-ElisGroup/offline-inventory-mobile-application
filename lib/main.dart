...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<InventoryOrderingFirebaseUser> userStream;
  InventoryOrderingFirebaseUser? initialUser;
  ...
  void initState() {
    super.initState();
    userStream = inventoryOrderingFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      'Delivery_Address': DeliveryAddressWidget(),
      'View_Orders': ViewOrdersWidget(),
