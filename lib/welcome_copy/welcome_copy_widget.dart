...
class WelcomeCopyWidget extends StatefulWidget {
  const WelcomeCopyWidget({Key? key}) : super(key: key);

  @override
  _WelcomeCopyWidgetState createState() => _WelcomeCopyWidgetState();
}
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                image: DecorationImage(
                                                  fit: BoxFit.contain,
                                                  image: Image.asset(
                                                    'assets/images/Modern_Login_Elis_App_2.png',
                                                  ).image,
                                                ),
                                              ),
                                            ),
